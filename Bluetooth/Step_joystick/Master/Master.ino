//cái này code giữ nguyên trạng thái khi có sự thay đổi thì mới đổi góc
...
void loop() {
  ...
  // Then check joystick directions
    ...
    if (VRY_value < 400) {         // UP
      BTSerial.write('0');
          Serial.println("UP: sending 0");
    }
    else if (VRY_value > 600) {    // DOWN
      BTSerial.write('1');
          Serial.println("DOWN: sending 1");
    }
