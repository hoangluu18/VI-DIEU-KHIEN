...
void executeCommand(char cmd) {
  switch (cmd) {
    ...
    case '1': // Quay 90 độ ngược chiều kim đồng hồ
      ...
      break;
    case '2': // Quay 180 độ ngược chiều kim đồng hồ
      myStepper.step(-STEPS_PER_REV / 2); // -1/2 vòng (180 độ)
      break;
    case '3': // Quay 45 độ ngược chiều kim đồng hồ
      myStepper.step(-STEPS_PER_REV / 8); // -1/8 vòng (45 độ)
      break;
    case '4': // Quay 90 độ theo chiều kim đồng hồ
      myStepper.step(STEPS_PER_REV / 4); // 1/4 vòng (90 độ)
      break;
    default:
